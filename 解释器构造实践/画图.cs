...
////数组赋值2
//bool ArrayAssignment2(MyNode uppernode)
//{
...
////逻辑表达式
//bool LogicExpression(MyNode uppernode)
//{//<逻辑表达式>	-><AND>||<逻辑表达式> |<AND>
...
////算数表达式
//bool MathematicExpression(MyNode uppernode)
//{
//    return MathematicExpression(uppernode, false);
//}
//bool MathematicExpression(MyNode uppernode, bool plusreverse)
//{//<算术表达式>	-><算数表达式2>+<算术表达式>|<算数表达式2>-<算术表达式>|<算数表达式2>
//    MyNode node = new MyNode("算数表达式");
//    int position = index;
//    if (!Math2(node, plusreverse))
//    {
//        return windBack(position);
//    }            //node.type = type;
//                 //node.settoken(token);
...
//    {
//        throwErr("MathematicExoression: +-符号后缺少算数表达式");
//        return windBack(position);
//    }
//    uppernode.AddNode(node);
//    return true;
...
//}
//bool ReverseSign(MyNode uppernode, String temp)
//{
//    getnext();
//    switch (token)
//    {
...
////算术表达式2
//bool Math2(MyNode uppernode, bool multreverse)
//{//<算术表达式>	-><算数表达式2>+<算术表达式>|<算数表达式2>-<算术表达式>|<算数表达式2>
//    MyNode node = new MyNode("算数表达式2");
//    int position = index;
//    if (!Math3(node))
//    {
//        return windBack(position);
...
//    //throwErr("算数表达式3什么都没有");
//    return false;
//}


//bool Math4(MyNode uppernode)
//{
...
//bool Negative(MyNode uppernode)
//{
...
//        return false;
//}
//bool PlusMinus(MyNode uppernode)
//{
...
//bool FunctionCall(MyNode uppernode)
//{//<函数调用>-><标志符>(<算术表达式>)
...
//bool BreakContinue(MyNode uppernode)
//{
